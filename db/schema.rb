...
ActiveRecord::Schema.define(version: 20170620125439) do
  ...
  create_table "developer_users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["email"], name: "index_developer_users_on_email", unique: true
    t.index ["reset_password_token"], name: "index_developer_users_on_reset_password_token", unique: true
  end
